                ...
                <ModalBody>
                    <LocalForm onSubmit={(value) => this.handleSubmit(value)}>
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                <Control.text model=".author" name="author" id="author" className="form-control" placeholder="Your Name"
                                    validators={{required:required, minLength: minLength(3), maxLength: maxLength(15)}}
                                />
                                <Errors
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={10}>
                                <Control.textarea model=".comment" name="comment" className="form-control" row="6"/>
                            </Col>
                        </Row>
                        <Row className="form-group">
...
function RenderComments({comments, postComment, dishId}) {
    if (comments != null) {
        ...
        return <div className="col-12 col-md-5 m-1"><CommentForm/></div>
    }
}
